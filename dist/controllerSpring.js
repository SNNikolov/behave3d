...
Behave3d.controllerSpring.prototype.update = function () {
	...
	if (this.paramsHaveChanged() || !this.computed_params) this.computed_params = this.getComputedLengths(['max_len']);

	var dpos = this.path_controllers.length > 0 ? this.getPathPos(this.path_controllers) : {
...
Behave3d.controllerSpring.prototype.setFixedPoint = function (fixed_point_id) {
	if (!this.zero_point) this.zero_point = Behave3d.getElementPos(this.owner.element, true);
