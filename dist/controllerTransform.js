...
Behave3d.controllerTransform.prototype.update = function () {
	...
	if (this.dx != 0 || this.dy != 0 || this.dz != 0) this.addTransform({
	...
	if (this.ra != 0) this.addTransform({
	...
	if (this.sx != 1 || this.sy != 1 || this.sz != 1) this.addTransform({
	...
	if (this.flatten) this.addTransform({
