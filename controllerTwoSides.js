...
Behave3d.controllerTwoSides.prototype.messages       = [
	"update", // Reads the first 2 children of this element in the DOM tree and sets them as sides of the surface
];
...
Behave3d.controllerTwoSides.prototype.default_params = {
	...
	flip_x    : false, // If true, then the back side will be rotated on axis X (instead of axis Y) by 180 degrees
};
...
Behave3d.controllerTwoSides.prototype.setSides = function()
{
	...
	if (this.targets.length != 2)
		Behave3d.debugExit("controllerTwoSides requires 2 child HTML elements which will become the sides of the plane");
