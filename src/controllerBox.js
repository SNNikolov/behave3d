...
Behave3d.controllerBox.prototype.messages       = [
	"update", // Reads the first 6 children of this element in the DOM tree and sets them as sides of the box
];
...
Behave3d.controllerBox.prototype.sides_orientation = [
	{rx: 0, ry: 0},
	{rx: 2, ry: 0},
	{rx: 0, ry: 1},
	{rx: 0, ry: -1},
...
Behave3d.controllerBox.prototype.update = function()
{
	if (this.targets.length == 6) {
		...
		for (var i = 0; i < 6; i++) {
			...
			var r;
			if (i == 0)      r = this.computed_params.z_size / 2;
			else if (i == 1) r = this.computed_params.z_size / 2;
			else if (i == 2) r = -this.computed_params.z_size / 2;
			else if (i == 3) r = -this.computed_params.x_size + this.computed_params.z_size / 2;
			else if (i == 4) r = this.computed_params.z_size / 2;
			else             r = this.computed_params.y_size - this.computed_params.z_size / 2;
