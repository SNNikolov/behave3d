...
Behave3d.controllerGravitate.prototype.default_params = {
	...
	paths       : "",  // A space-delimited list of controller ids; the sum of these controllers' current coordinates makes the "source of gravity"
};
...
Behave3d.controllerGravitate.prototype.update = function()
{
	...
	if (this.path_controllers.length > 0)
		var dpos = this.getPathPos(this.path_controllers);
	else {
