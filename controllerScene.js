...
Behave3d.controllerScene.prototype.events         = [
	"viewport_update", // Fired upon updating the viewport
];
Behave3d.controllerScene.prototype.messages       = [
	"params", // Set new values of the scene parameters (perspective, ..)
];
Behave3d.controllerScene.prototype.default_params = {
	...
	update_perspective   : true,    // If true, then the scene's perspective-origin style property is updated upon window scrolling and is set to point at the viewport's center
};
...
{
	if (!this.paused && this.needUpdate)
		this.updateViewport();			
};
