...
Behave3d.controllerCircle.prototype.events         = [
...
Behave3d.controllerCircle.prototype.messages       = [
...
Behave3d.controllerCircle.prototype.update = function()
{
	...
	if (this.paramsHaveChanged() || !this.computed_params)
		this.computed_params = this.getComputedLengths(['x_radius', 'x_center'], ['y_radius', 'y_center']);
